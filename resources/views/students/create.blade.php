...
@section('content')
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-slate-900">Registrar estudiante</h2>
        <a href="{{ route('students.index') }}" class="text-sm text-indigo-600 hover:underline">&larr; Volver</a>
    </div>
        ...
        <form method="POST" action="{{ route('students.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="mother_last_name" id="mother_last_name" value="{{ old('mother_last_name') }}"
                           class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="discount" id="discount" min="0" max="100" step="0.01" value="{{ old('discount', 0) }}"
                           class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
            </div>
